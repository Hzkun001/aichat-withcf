...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/aichat-withcf)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aichat-withcf
```

A live public deployment of this template is available at [https://aichat-withcf.templates.workers.dev](https://aichat-withcf.templates.workers.dev)
